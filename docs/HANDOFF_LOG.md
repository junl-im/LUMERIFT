...
- v17 플레이어 방향 파츠 32프레임, 몬스터 전신 파츠 24프레임, 보스 코어 24프레임, UI 아이콘 24프레임 추가
- 전투·캐릭터 스튜디오·인벤토리에서 v17을 우선 사용하고 v16 이하를 안전 폴백으로 유지
- 최종 8방향 전신 수작업 Atlas와 실제 모바일 기기 승인은 미완료

## 2026-08-03 · v1.11.34

- 플레이어 공격·회피·스킬 8방향 동작 오버레이 48프레임을 전투와 캐릭터 스튜디오에 연결했다.
- Void·Frost·Inferno 엘리트와 Abyssal 보스 모션 오버레이 32프레임을 연결했다.
- 보스 코어 파괴·재생 루프를 30프레임으로 확대했다.
- Premium UI Icons v18 16프레임을 전투·캐릭터 스튜디오·인벤토리에 적용했다.
- Player Save v4·AttackFootprint·App Check 비활성 정책을 유지했다.
- 최종 전신 수작업 Atlas와 Android/iOS 승인, 정상 npm build는 미완료로 유지했다.


## 2026-08-03 · v1.11.35

- 플레이어 접촉·유지·회수 3단계 8방향 액션 파츠 72프레임을 전투와 캐릭터 스튜디오에 연결했다.
- Void·Frost·Inferno·Abyssal 계열의 4방향 사지 오버레이 48프레임을 연결했다.
- 보스 코어 연속 파편 궤적 36프레임과 Premium Combat VFX 24프레임을 추가했다.
- v18 이하 폴백, Player Save v4, AttackFootprint, App Check 비활성 정책을 유지했다.
- 최종 전신 수작업 Atlas와 실기기 승인, 실제 의존성 build는 미완료로 유지했다.

## 2026-08-03 · v1.11.36

- 검·대검·균열 장창 8방향 5단계 액션 오버레이 120프레임을 전투와 캐릭터 스튜디오에 연결했다.
- Void·Frost·Inferno·Abyssal 계열의 8방향 피격·다운 오버레이 128프레임을 연결했다.
