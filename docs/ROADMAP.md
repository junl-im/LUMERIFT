...
## 다음: v1.10.1 물리 단말 계측·접근성 보강

- [ ] Android Chrome·Samsung Internet 360~430px 폭 실제 FPS·발열·GPU 메모리 계측
- [ ] iOS Safari 노치·홈 인디케이터·주소창·가상 키보드 실기기 캡처
- [ ] 색약·저시력 모드 대비와 HUD 색상 중복 표현
- [ ] 실제 계측 결과 기반 캔버스 resolution·파티클·FPS 자동 단계 조정
- [ ] LUMERIFT 전용 플레이어 8방향 실루엣 원화 1차
- [ ] 시즌 종료 기록과 복구 지점 JSON 내보내기·가져오기
