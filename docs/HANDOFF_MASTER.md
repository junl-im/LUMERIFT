...
**현재 버전:** v1.11.5
**갱신일:** 2026-07-29  
**상태:** 웹툰형 UI 리디자인·전투 HUD 대정리·방향/타격 피드백 polish 완료
...
- 웹툰형 클린 UI 패널·버튼 장식 추가
- 전투 HUD 카드 레이아웃과 ATTACK VECTOR 패널 추가
- 방향 검수 보조와 CHAIN/CRITICAL 타격 피드백 추가
...
1. 전투 HUD 실브라우저·실기기 미세 정렬
2. 캐릭터 8방향 공격 성공 프레임·타격 포즈 검수
3. 보스 말풍선형 위험 아이콘과 패턴 강조 개선
4. Android Chrome·iOS Safari 장시간 전투 UI/성능 검증
