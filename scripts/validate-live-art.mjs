...
const errors = [];
const summary = JSON.parse(await readFile('public/assets/LIVE_ART_V120_SUMMARY.json', 'utf8'));
...
if (summary.release !== '1.2.0') errors.push(`live art release mismatch: ${summary.release}`);
if (summary.qualityStage !== 'production-candidate-open-art-pass') errors.push(`live art stage mismatch: ${summary.qualityStage}`);
if ((summary.runtimeBytes ?? 0) < 3_000_000) errors.push('v1.2 실사용 런타임 아트가 3 MB 미만입니다.');
if (!Array.isArray(licenses.assets) || licenses.assets.length < 8) errors.push('제3자 에셋 라이선스 기록이 부족합니다.');

const expected = [
  'public/assets/live/v2/atlases/player/player_live_v2.json',
  'public/assets/live/v2/atlases/player/player_live_v2.webp',
  'public/assets/live/v2/atlases/monsters/monsters_live_v2.json',
  'public/assets/live/v2/atlases/monsters/monsters_live_v2.webp',
  'public/assets/live/v2/atlases/ui/ui_obsidian_v2.json',
  'public/assets/live/v2/atlases/ui/ui_obsidian_v2.webp',
  'public/assets/live/v2/backgrounds/lobby_forest_v2.webp',
  'public/assets/live/v2/backgrounds/battle_forest_v2.webp',
  'public/assets/live/v2/portraits/hero_v2.webp',
  'public/assets/live/v2/portraits/boss_v2.webp',
...
for (const fragment of [
  'assets/live/v2/atlases/ui/ui_obsidian_v2.json',
  'assets/live/v2/atlases/player/player_live_v2.json',
  'assets/live/v2/atlases/monsters/monsters_live_v2.json',
  'assets/live/v2/backgrounds/battle_forest_v2.webp',
]) {
  if (!catalog.includes(fragment)) errors.push(`AssetCatalog 기본 경로가 v1.2 아트를 가리키지 않습니다: ${fragment}`);
}
...
if (errors.length) {
  ...
  console.log(`PASS live art v1.2: ${summary.runtimeFiles} files, ${(summary.runtimeBytes / 1_000_000).toFixed(2)} MB, ${licenses.assets.length} licensed source groups`);
}
